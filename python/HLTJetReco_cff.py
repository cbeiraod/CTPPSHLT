...
hltL1sSingleJet170IorSingleJet180IorSingleJet200 = cms.EDFilter( "HLTL1TSeed",
...
hltPreCaloJet550NoJetID = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
hltSingleCaloJet550 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
hltL1sSingleJet180 = cms.EDFilter( "HLTL1TSeed",
...
hltPreAK8PFJet360TrimMass30 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
hltAK8CaloRelativeCorrector = cms.EDProducer( "LXXXCorrectorProducer",
    algorithm = cms.string( "AK8CaloHLT" ),
    level = cms.string( "L2Relative" )
)
hltAK8CaloAbsoluteCorrector = cms.EDProducer( "LXXXCorrectorProducer",
    algorithm = cms.string( "AK8CaloHLT" ),
    level = cms.string( "L3Absolute" )
)
hltAK8CaloResidualCorrector = cms.EDProducer( "LXXXCorrectorProducer",
    algorithm = cms.string( "AK8CaloHLT" ),
    level = cms.string( "L2L3Residual" )
)
hltAK8CaloCorrector = cms.EDProducer( "ChainedJetCorrectorProducer",
...
hltAK8CaloJetsCorrected = cms.EDProducer( "CorrectedCaloJetProducer",
    src = cms.InputTag( "hltAK8CaloJets" ),
    correctors = cms.VInputTag( 'hltAK8CaloCorrector' )
)
hltAK8CaloJetsCorrectedIDPassed = cms.EDProducer( "CorrectedCaloJetProducer",
...
hltIterL3MuonsFromL2 = cms.EDProducer( "L3TrackCombiner",
    labels = cms.VInputTag( 'hltL3MuonsIterL3OI','hltL3MuonsIterL3IO' )
)
hltIterL3MuonL1MuonNoL2Selector = cms.EDProducer( "HLTL1MuonNoL2Selector",
...
hltL3MuonsIterL3Links = cms.EDProducer( "MuonLinksProducerForHLT",
    pMin = cms.double( 2.5 ),
...
hltIterL3Muons = cms.EDProducer( "MuonIdProducer",
...
hltPixelTripletsClustersRefRemoval = cms.EDProducer( "TrackClusterRemover",
    trackClassifier = cms.InputTag( '','QualityMasks' ),
    minNumberOfLayersWithMeasBeforeFiltering = cms.int32( 0 ),
...
hltPixelTracksTrackingRegionsForTriplets = cms.EDProducer( "PointSeededTrackingRegionsEDProducer",
    RegionPSet = cms.PSet(
...
hltPixelLayerTripletsWithClustersRemoval = cms.EDProducer( "SeedingLayersEDProducer",
    layerList = cms.vstring( 'BPix1+BPix2+BPix3',
      'BPix2+BPix3+BPix4',
      'BPix1+BPix3+BPix4',
      'BPix1+BPix2+BPix4',
...
hltPixelTracksHitDoubletsForTriplets = cms.EDProducer( "HitPairEDProducer",
...
hltPixelTracksHitTriplets = cms.EDProducer( "CAHitTripletEDProducer",
    CAHardPtCut = cms.double( 0.0 ),
    SeedComparitorPSet = cms.PSet(
      clusterShapeHitFilter = cms.string( "ClusterShapeHitFilter" ),
      ComponentName = cms.string( "LowPtClusterShapeSeedComparitor" ),
...
hltPixelTracksFromTriplets = cms.EDProducer( "PixelTrackProducer",
    Filter = cms.InputTag( "hltPixelTracksFilter" ),
    Cleaner = cms.string( "hltPixelTracksCleanerBySharedHits" ),
    passLabel = cms.string( "" ),
    Fitter = cms.InputTag( "hltPixelTracksFitter" ),
...
hltPixelTracksMerged = cms.EDProducer( "TrackListMerger",
    ShareFrac = cms.double( 0.19 ),
    writeOnlyTrkQuals = cms.bool( False ),
    MinPT = cms.double( 0.05 ),
    allowFirstHitShare = cms.bool( True ),
...
hltTripletRecoveryClustersRefRemoval = cms.EDProducer( "TrackClusterRemover",
    trackClassifier = cms.InputTag( '','QualityMasks' ),
    minNumberOfLayersWithMeasBeforeFiltering = cms.int32( 0 ),
    maxChi2 = cms.double( 16.0 ),
...
hltTripletRecoveryMaskedMeasurementTrackerEvent = cms.EDProducer( "MaskedMeasurementTrackerEventProducer",
    clustersToSkip = cms.InputTag( "hltTripletRecoveryClustersRefRemoval" ),
    OnDemand = cms.bool( False ),
    src = cms.InputTag( "hltSiStripClusters" )
)
hltTripletRecoveryPixelLayerTriplets = cms.EDProducer( "SeedingLayersEDProducer",
    layerList = cms.vstring( 'BPix1+BPix2+BPix3',
      'BPix2+BPix3+BPix4',
      'BPix1+BPix3+BPix4',
      'BPix1+BPix2+BPix4',
...
hltTripletRecoveryPFlowPixelTrackingRegions = cms.EDProducer( "PointSeededTrackingRegionsEDProducer",
    RegionPSet = cms.PSet(
      vertexCollection = cms.InputTag( "hltTrimmedPixelVertices" ),
      zErrorVetex = cms.double( 0.1 ),
      beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
...
hltTripletRecoveryPFlowPixelClusterCheck = cms.EDProducer( "ClusterCheckerEDProducer",
    cut = cms.string( "" ),
    silentClusterCheck = cms.untracked.bool( False ),
    MaxNumberOfCosmicClusters = cms.uint32( 50000 ),
    PixelClusterCollectionLabel = cms.InputTag( "hltSiPixelClusters" ),
...
hltTripletRecoveryPFlowPixelHitDoublets = cms.EDProducer( "HitPairEDProducer",
...
hltTripletRecoveryPFlowPixelHitTriplets = cms.EDProducer( "CAHitTripletEDProducer",
    CAHardPtCut = cms.double( 0.3 ),
    SeedComparitorPSet = cms.PSet(  ComponentName = cms.string( "none" ) ),
    extraHitRPhitolerance = cms.double( 0.032 ),
...
hltTripletRecoveryPFlowPixelSeeds = cms.EDProducer( "SeedCreatorFromRegionConsecutiveHitsTripletOnlyEDProducer",
    SeedComparitorPSet = cms.PSet(  ComponentName = cms.string( "none" ) ),
    forceKinematicWithRegionDirection = cms.bool( False ),
    magneticField = cms.string( "ParabolicMf" ),
    SeedMomentumForBOFF = cms.double( 5.0 ),
...
hltTripletRecoveryPFlowCkfTrackCandidates = cms.EDProducer( "CkfTrackCandidateMaker",
...
hltTripletRecoveryPFlowCtfWithMaterialTracks = cms.EDProducer( "TrackProducer",
...
hltTripletRecoveryPFlowTrackCutClassifier = cms.EDProducer( "TrackCutClassifier",
...
hltTripletRecoveryPFlowTrackSelectionHighPurity = cms.EDProducer( "TrackCollectionFilterCloner",
    minQuality = cms.string( "highPurity" ),
    copyExtras = cms.untracked.bool( True ),
    copyTrajectories = cms.untracked.bool( False ),
...
hltTripletRecoveryMerged = cms.EDProducer( "TrackListMerger",
    ShareFrac = cms.double( 0.19 ),
    writeOnlyTrkQuals = cms.bool( False ),
    MinPT = cms.double( 0.05 ),
    allowFirstHitShare = cms.bool( True ),
...
hltDoubletRecoveryPixelLayerPairs = cms.EDProducer( "SeedingLayersEDProducer",
...
hltDoubletRecoveryPFlowPixelTrackingRegions = cms.EDProducer( "PointSeededTrackingRegionsEDProducer",
    RegionPSet = cms.PSet(
      vertexCollection = cms.InputTag( "hltTrimmedPixelVertices" ),
      zErrorVetex = cms.double( 0.1 ),
      beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
...
hltAK8PFJetsLooseID = cms.EDProducer( "HLTPFJetIDProducer",
    CEF = cms.double( 0.99 ),
    NHF = cms.double( 0.99 ),
...
hltAK8PFJetsTightID = cms.EDProducer( "HLTPFJetIDProducer",
    CEF = cms.double( 0.99 ),
    NHF = cms.double( 0.9 ),
    minPt = cms.double( 20.0 ),
    CHF = cms.double( 0.0 ),
...
hltAK8PFFastJetCorrector = cms.EDProducer( "L1FastjetCorrectorProducer",
    srcRho = cms.InputTag( "hltFixedGridRhoFastjetAll" ),
    algorithm = cms.string( "AK8PFHLT" ),
    level = cms.string( "L1FastJet" )
)
hltAK8PFRelativeCorrector = cms.EDProducer( "LXXXCorrectorProducer",
    algorithm = cms.string( "AK8PFHLT" ),
    level = cms.string( "L2Relative" )
)
hltAK8PFAbsoluteCorrector = cms.EDProducer( "LXXXCorrectorProducer",
    algorithm = cms.string( "AK8PFHLT" ),
    level = cms.string( "L3Absolute" )
)
hltAK8PFResidualCorrector = cms.EDProducer( "LXXXCorrectorProducer",
    algorithm = cms.string( "AK8PFHLT" ),
    level = cms.string( "L2L3Residual" )
)
hltAK8PFCorrector = cms.EDProducer( "ChainedJetCorrectorProducer",
...
hltAK8PFJetsLooseIDCorrected = cms.EDProducer( "CorrectedPFJetProducer",
    src = cms.InputTag( "hltAK8PFJetsLooseID" ),
    correctors = cms.VInputTag( 'hltAK8PFCorrector' )
)
hltAK8PFJetsTightIDCorrected = cms.EDProducer( "CorrectedPFJetProducer",
...
hltAK8SinglePFJet360 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 2.5 ),
...
hltAK8SinglePFJetTrimModMass30 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 2.5 ),
...
hltPreDiPFJetAve260 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
hltDiCaloJetAve210 = cms.EDFilter( "HLTDiCaloJetAveFilter",
    saveTags = cms.bool( True ),
...
hltDiPFJetAve260 = cms.EDFilter( "HLTDiPFJetAveFilter",
    saveTags = cms.bool( True ),
...
hltSingleCaloJet450AK8 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
hltPFJetsCorrectedMatchedToCaloJets450AK8 = cms.EDProducer( "PFJetsMatchedToFilteredCaloJetsProducer",
    DeltaR = cms.double( 0.5 ),
    CaloJetFilter = cms.InputTag( "hltSingleCaloJet450AK8" ),
    TriggerType = cms.int32( 85 ),
    PFJetSrc = cms.InputTag( "hltAK8PFJetsCorrected" )
)
hltSinglePFJet500AK8 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
hltPrePFJetFwd400 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
hltSingleCaloFwdJet350 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
hltPFJetsCorrectedMatchedToCaloFwdJets350 = cms.EDProducer( "PFJetsMatchedToFilteredCaloJetsProducer",
    DeltaR = cms.double( 0.5 ),
    CaloJetFilter = cms.InputTag( "hltSingleCaloFwdJet350" ),
    TriggerType = cms.int32( 85 ),
    PFJetSrc = cms.InputTag( "hltAK4PFJetsCorrected" )
)
hltSinglePFFwdJet400 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
hltL1DiJetVBF = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleJet_90_30_DoubleJet30_Mass_Min620 OR L1_DoubleJet_100_30_DoubleJet30_Mass_Min620 OR L1_DoubleJet_100_35_DoubleJet35_Mass_Min620 OR L1_DoubleJet_110_35_DoubleJet35_Mass_Min620 OR L1_DoubleJet_110_40_DoubleJet40_Mass_Min620 OR L1_DoubleJet_115_35_DoubleJet35_Mass_Min620 OR L1_DoubleJet_115_40_DoubleJet40_Mass_Min620" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
hltPreDiJet11035Mjj650PFMET110 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
hltCaloMETOpen = cms.EDFilter( "HLT1CaloMET",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
...
hltHcalTowerNoiseCleanerWithrechit = cms.EDProducer( "HLTHcalTowerNoiseCleanerWithrechit",
    TS4TS5EnergyThreshold = cms.double( 50.0 ),
    TS4TS5UpperThreshold = cms.vdouble( 70.0, 90.0, 100.0, 400.0, 4000.0 ),
...
hltCaloNoiseCleanedMET66 = cms.EDFilter( "HLT1CaloMET",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( -1.0 ),
...
hltParticleFlowNoMu = cms.EDFilter( "GenericPFCandidateSelector",
    src = cms.InputTag( "hltParticleFlow" ),
    cut = cms.string( "particleId!=3" )
)
hltPFMETVBFProducer = cms.EDProducer( "PFMETProducer",
    globalThreshold = cms.double( 0.0 ),
    calculateSignificance = cms.bool( False ),
    alias = cms.string( "pfMet" ),
    src = cms.InputTag( "hltParticleFlowNoMu" )
)
hltPFMETVBF110 = cms.EDFilter( "HLT1PFMET",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( -1.0 ),
...
hltL1TPFJetsMatching = cms.EDProducer( "L1TPFJetsMatching",
...
hltL1PFJetCategories = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
    MaxMass = cms.double( -1.0 ),
    MinN = cms.int32( 2 ),
    MaxEta = cms.double( -1.0 ),
...
HLTAK4CaloJetsCorrectionNoIDSequence = cms.Sequence( hltFixedGridRhoFastjetAllCalo + HLTAK4CaloCorrectorProducersSequence + hltAK4CaloJetsCorrected )
HLTEndSequence = cms.Sequence( hltBoolEnd )
HLTAK8CaloJetsReconstructionSequence = cms.Sequence( HLTDoCaloSequence + hltAK8CaloJets + hltAK8CaloJetsIDPassed )
HLTAK8CaloCorrectorProducersSequence = cms.Sequence( hltAK8CaloFastJetCorrector + hltAK8CaloRelativeCorrector + hltAK8CaloAbsoluteCorrector + hltAK8CaloResidualCorrector + hltAK8CaloCorrector )
HLTAK8CaloJetsCorrectionSequence = cms.Sequence( hltFixedGridRhoFastjetAllCalo + HLTAK8CaloCorrectorProducersSequence + hltAK8CaloJetsCorrected + hltAK8CaloJetsCorrectedIDPassed )
...
HLTIterativeTrackingIter02ForIterL3Muon = cms.Sequence( HLTIterativeTrackingIteration0ForIterL3Muon + HLTIterativeTrackingIteration2ForIterL3Muon + hltIter2IterL3MuonMerged )
HLTIterL3IOmuonTkCandidateSequence = cms.Sequence( HLTIterL3MuonRecopixelvertexingSequence + HLTIterativeTrackingIter02ForIterL3Muon + hltL3MuonsIterL3IO )
HLTIterL3OIAndIOFromL2muonTkCandidateSequence = cms.Sequence( HLTIterL3OImuonTkCandidateSequence + hltIterL3OIL3MuonsLinksCombination + hltIterL3OIL3Muons + hltIterL3OIL3MuonCandidates + hltL2SelectorForL3IO + HLTIterL3IOmuonTkCandidateSequence + hltIterL3MuonsFromL2LinksCombination + hltIterL3MuonsFromL2 )
...
HLTIterativeTrackingIter02ForIterL3FromL1Muon = cms.Sequence( HLTIterativeTrackingIteration0ForIterL3FromL1Muon + HLTIterativeTrackingIteration2ForIterL3FromL1Muon + hltIter2IterL3FromL1MuonMerged )
HLTIterL3IOmuonFromL1TkCandidateSequence = cms.Sequence( HLTRecopixelvertexingSequenceForIterL3FromL1Muon + HLTIterativeTrackingIter02ForIterL3FromL1Muon )
HLTIterL3muonTkCandidateSequence = cms.Sequence( HLTDoLocalPixelSequence + HLTDoLocalStripSequence + HLTIterL3OIAndIOFromL2muonTkCandidateSequence + hltIterL3MuonL1MuonNoL2Selector + HLTIterL3IOmuonFromL1TkCandidateSequence )
HLTL3muonrecoNocandSequence = cms.Sequence( HLTIterL3muonTkCandidateSequence + hltIterL3MuonMerged + hltIterL3MuonAndMuonFromL1Merged + hltL3MuonsIterL3Links + hltIterL3Muons )
HLTL3muonrecoSequence = cms.Sequence( HLTL3muonrecoNocandSequence + hltIterL3MuonCandidates )
HLTRecoPixelTracksSequence = cms.Sequence( hltPixelTracksFilter + hltPixelTracksFitter + hltPixelTracksTrackingRegions + hltPixelLayerQuadruplets + hltPixelTracksHitDoublets + hltPixelTracksHitQuadruplets + hltPixelTracks + hltPixelTripletsClustersRefRemoval + hltPixelTracksTrackingRegionsForTriplets + hltPixelLayerTripletsWithClustersRemoval + hltPixelTracksHitDoubletsForTriplets + hltPixelTracksHitTriplets + hltPixelTracksFromTriplets + hltPixelTracksMerged )
...
HLTIterativeTrackingTripletRecovery = cms.Sequence( hltTripletRecoveryClustersRefRemoval + hltTripletRecoveryMaskedMeasurementTrackerEvent + hltTripletRecoveryPixelLayerTriplets + hltTripletRecoveryPFlowPixelTrackingRegions + hltTripletRecoveryPFlowPixelClusterCheck + hltTripletRecoveryPFlowPixelHitDoublets + hltTripletRecoveryPFlowPixelHitTriplets + hltTripletRecoveryPFlowPixelSeeds + hltTripletRecoveryPFlowCkfTrackCandidates + hltTripletRecoveryPFlowCtfWithMaterialTracks + hltTripletRecoveryPFlowTrackCutClassifier + hltTripletRecoveryPFlowTrackSelectionHighPurity )
...
HLTIterativeTrackingIter02 = cms.Sequence( HLTIterativeTrackingIteration0 + HLTIterativeTrackingIteration1 + hltIter1Merged + HLTIter1TrackAndTauJets4Iter2Sequence + HLTIterativeTrackingIteration2 + hltIter2Merged + HLTIterativeTrackingTripletRecovery + hltTripletRecoveryMerged + HLTIterativeTrackingDoubletRecovery + hltMergedTracks )
...
HLTAK8PFJetsReconstructionSequence = cms.Sequence( HLTL2muonrecoSequence + HLTL3muonrecoSequence + HLTTrackReconstructionForPF + HLTParticleFlowSequence + hltAK8PFJets + hltAK8PFJetsLooseID + hltAK8PFJetsTightID )
HLTAK8PFCorrectorProducersSequence = cms.Sequence( hltAK8PFFastJetCorrector + hltAK8PFRelativeCorrector + hltAK8PFAbsoluteCorrector + hltAK8PFResidualCorrector + hltAK8PFCorrector )
HLTAK8PFJetsCorrectionSequence = cms.Sequence( hltFixedGridRhoFastjetAll + HLTAK8PFCorrectorProducersSequence + hltAK8PFJetsCorrected + hltAK8PFJetsLooseIDCorrected + hltAK8PFJetsTightIDCorrected )
...
HLTHBHENoiseCleanerSequence = cms.Sequence( hltHcalNoiseInfoProducer + hltHcalTowerNoiseCleanerWithrechit )

HLTriggerFirstPath = cms.Path( hltGetConditions + hltGetRaw + hltBoolFalse )
#HLT_CaloJet500_NoJetID_v10 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 + hltPreCaloJet500NoJetID + HLTAK4CaloJetsReconstructionNoIDSequence + HLTAK4CaloJetsCorrectionNoIDSequence + hltSingleCaloJet500 + HLTEndSequence )
#HLT_CaloJet550_NoJetID_v5 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 + hltPreCaloJet550NoJetID + HLTAK4CaloJetsReconstructionNoIDSequence + HLTAK4CaloJetsCorrectionNoIDSequence + hltSingleCaloJet550 + HLTEndSequence )
#HLT_AK8PFJet360_TrimMass30_v14 = cms.Path( HLTBeginSequence + hltL1sSingleJet180 + hltPreAK8PFJet360TrimMass30 + HLTAK8CaloJetsSequence + hltAK8SingleCaloJet260 + HLTAK8PFJetsSequence + hltAK8PFJetsCorrectedMatchedToCaloJets260 + hltAK8SinglePFJet360 + hltAK8TrimModJets + hltAK8SinglePFJetTrimModMass30 + HLTEndSequence )
#HLT_AK8PFJet500_v12 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 + hltPreAK8PFJet500 + HLTAK8CaloJetsSequence + hltSingleCaloJet450AK8 + HLTAK8PFJetsSequence + hltPFJetsCorrectedMatchedToCaloJets450AK8 + hltSinglePFJet500AK8 + HLTEndSequence )
HLT_PFJet500_v17 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 + hltPrePFJet500 + HLTAK4CaloJetsSequence + hltSingleCaloJet450 + HLTAK4PFJetsSequence + hltPFJetsCorrectedMatchedToCaloJets450 + hltSinglePFJet500 + HLTEndSequence )
#HLT_PFJetFwd400_v15 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 + hltPrePFJetFwd400 + HLTAK4CaloJetsSequence + hltSingleCaloFwdJet350 + HLTAK4PFJetsSequence + hltPFJetsCorrectedMatchedToCaloFwdJets350 + hltSinglePFFwdJet400 + HLTEndSequence )
#HLT_DiJet110_35_Mjj650_PFMET110_v5 = cms.Path( HLTBeginSequence + hltL1DiJetVBF + hltPreDiJet11035Mjj650PFMET110 + HLTRecoMETSequence + hltCaloMETOpen + HLTHBHENoiseCleanerSequence + hltMetClean + hltCaloNoiseCleanedMET66 + HLTAK4PFJetsSequence + hltParticleFlowNoMu + hltPFMETVBFProducer + hltPFMETVBF110 + hltL1TPFJetsMatching + hltL1PFJetCategories + HLTEndSequence )
HLTriggerFinalPath = cms.Path( hltGtStage2Digis + hltScalersRawToDigi + hltFEDSelector + hltTriggerSummaryAOD + hltTriggerSummaryRAW + hltBoolFalse )
HLT_DiPFJetAve260_v10 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 + hltPreDiPFJetAve260 + HLTAK4CaloJetsSequence + hltDiCaloJetAve210 + HLTAK4PFJetsSequence + hltDiPFJetAve260 + HLTEndSequence )

maxTracksPerArm = 1

load("EventFilter.CTPPSRawToDigi.ctppsRawToDigi_cff")
load("RecoCTPPS.Configuration.recoCTPPS_cff")
load("UserCode.CTPPSHLT.hltCTPPSLocalTrackFilter_cfi")
hltCTPPSLocalTrackFilter.maxTracksPerArm = cms.int32(maxTracksPerArm)
hltPreCTPPSCoincidence = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
HLT_CTPPSCoincidence_v0 = cms.Path( HLTBeginSequence + hltPreCTPPSCoincidence + ctppsRawToDigi + recoCTPPS + hltCTPPSLocalTrackFilter + HLTEndSequence )
hltPreCTPPSCoincidenceL1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
HLT_CTPPSCoincidenceL1_v0 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 + hltPreCTPPSCoincidenceL1 + ctppsRawToDigi + recoCTPPS + hltCTPPSLocalTrackFilter + HLTEndSequence )
hltPreDiPFJetAve260 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
HLT_CTPPS_DiPFJetAve260_v0 = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                               hltPreDiPFJetAve260 +
                                               ctppsRawToDigi + recoCTPPS + hltCTPPSLocalTrackFilter +
                                               HLTAK4CaloJetsSequence +
                                               hltDiCaloJetAve210 + HLTAK4PFJetsSequence +
                                               hltDiPFJetAve260 + HLTEndSequence )

hltPreDiPFJetAve240 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
hltDiCaloJetAve200 = cms.EDFilter( "HLTDiCaloJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4CaloJetsCorrectedIDPassed" ),
...
hltDiPFJetAve240 = cms.EDFilter( "HLTDiPFJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4PFJetsCorrected" ),
...
HLT_DiPFJetAve240_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve240 +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve200 + HLTAK4PFJetsSequence +
                                           hltDiPFJetAve240 + HLTEndSequence )
HLT_CTPPS_DiPFJetAve240_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve240 +
                                           ctppsRawToDigi + recoCTPPS + hltCTPPSLocalTrackFilter +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve200 + HLTAK4PFJetsSequence +
...
hltPreDiPFJetAve220 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
hltDiCaloJetAve190 = cms.EDFilter( "HLTDiCaloJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4CaloJetsCorrectedIDPassed" ),
...
hltDiPFJetAve220 = cms.EDFilter( "HLTDiPFJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4PFJetsCorrected" ),
...
HLT_DiPFJetAve220_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve220 +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve190 + HLTAK4PFJetsSequence +
                                           hltDiPFJetAve220 + HLTEndSequence )
HLT_CTPPS_DiPFJetAve220_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve220 +
                                           ctppsRawToDigi + recoCTPPS + hltCTPPSLocalTrackFilter +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve190 + HLTAK4PFJetsSequence +
...
hltPreDiPFJetAve200 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
hltDiCaloJetAve180 = cms.EDFilter( "HLTDiCaloJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4CaloJetsCorrectedIDPassed" ),
...
hltDiPFJetAve200 = cms.EDFilter( "HLTDiPFJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4PFJetsCorrected" ),
    minPtAve = cms.double( 200.0 ),
    minPtJet3 = cms.double( 99999.0 ),
...
HLT_DiPFJetAve200_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve200 +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve180 + HLTAK4PFJetsSequence +
                                           hltDiPFJetAve200 + HLTEndSequence )
HLT_CTPPS_DiPFJetAve200_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve200 +
                                           ctppsRawToDigi + recoCTPPS + hltCTPPSLocalTrackFilter +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve180 + HLTAK4PFJetsSequence +
...
hltPreDiPFJetAve180 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
hltDiCaloJetAve170 = cms.EDFilter( "HLTDiCaloJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4CaloJetsCorrectedIDPassed" ),
...
hltDiPFJetAve180 = cms.EDFilter( "HLTDiPFJetAveFilter",
    saveTags = cms.bool( True ),
    inputJetTag = cms.InputTag( "hltAK4PFJetsCorrected" ),
    minPtAve = cms.double( 180.0 ),
    minPtJet3 = cms.double( 99999.0 ),
...
HLT_DiPFJetAve180_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve180 +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve170 + HLTAK4PFJetsSequence +
                                           hltDiPFJetAve180 + HLTEndSequence )
HLT_CTPPS_DiPFJetAve180_test = cms.Path( HLTBeginSequence + hltL1sSingleJet170IorSingleJet180IorSingleJet200 +
                                           hltPreDiPFJetAve180 +
                                           ctppsRawToDigi + recoCTPPS + hltCTPPSLocalTrackFilter +
                                           HLTAK4CaloJetsSequence +
                                           hltDiCaloJetAve170 + HLTAK4PFJetsSequence +
