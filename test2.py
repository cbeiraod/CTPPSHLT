...
#process.hltCTPPSLocalTrackFilter = cms.EDFilter('HLTCTPPSLocalTrackFilter'
#)

#process.p = cms.Path(process.ctppsRawToDigi * process.recoCTPPS * process.hltCTPPSLocalTrackFilter)
